function dotacje() {
     document.getElementById("collapseMain").innerHTML = "<br> <p> Skorzystaj na naszym doświadczeniu!Pomagamy uzyskać dotacje na otwarcie działalności, a także na rozwój i inwestycje Twojej firmy. </p>" +
     ...
     document.getElementById("collapseCard").innerHTML = document.getElementById('dotacje').innerHTML;
...
function kadryIPlace() {
     document.getElementById("collapseMain").innerHTML = "<div class='row'><div class='col-md-6'>" +
          ...
          "</div></div>";
     document.getElementById("collapseCard").innerHTML = document.getElementById('kadryIPlace').innerHTML;
     location.href = "#oferta";
...
function rozliczeniePIT() {
     document.getElementById("collapseMain").innerHTML = "<br><p>Rozliczenie odbywa się za pośrednictwem: drogi elektronicznej tj.poprzez wysyłkę elektroniczną bezpośrednią do Urzędu Skarbowego(wówczas niezbędne jest podanie kwota przychodu z rozliczenia PIT za rok ubiegły)</p>";
     document.getElementById("collapseCard").innerHTML = document.getElementById('rozliczeniePIT').innerHTML;
     location.href = "#oferta";
...
function ksiegiHandlowe() {
     document.getElementById("collapseMain").innerHTML = "<li>prowadzenie Ksiąg rachunkowych i wyliczenie na tej podstawie miesięcznej / kwartalnej zaliczki na podatek dochodowy CIT lub PIT,</li>" +
     ...
     document.getElementById("collapseCard").innerHTML = document.getElementById('ksiegiHandlowe').innerHTML;
     location.href = "#oferta";
...
function ryczalt() {
     document.getElementById("collapseMain").innerHTML = "<li>prowadzenie ewidencji przychodów i wyliczenie na tej podstawie zaliczki na podatek dochodowy miesięcznie lub kwartalnie,</li>" +
          "<li>rozliczanie podatku VAT obejmujące prowadzenie właściwych rejestrów VAT, sporządzanie miesięcznych lub kwartalnych deklaracji VAT,</li>" +
     ...
     document.getElementById("collapseCard").innerHTML = document.getElementById('ryczalt').innerHTML;
     location.href = "#oferta";
...
function podatkowaKsiega() {
     document.getElementById("collapseMain").innerHTML = "<li>prowadzenie Księgi Przychodów i Rozchodów i wyliczenie na jej podstawie miesięcznej / kwartalnej zaliczki na podatek dochodowy PIT,</li>" +
          "<li>rozliczanie podatku VAT obejmujące prowadzenie właściwych rejestrów VAT, sporządzanie miesięcznych lub kwartalnych deklaracji VAT</li>" +
          "<li>rozliczanie transakcji wewnątrzwspólnotowych oraz exportu / importu towarów i usług obejmujące wystawianie FV wewnętrznych, prowadzenie właściwych rejestrów VAT, sporządzanie miesięcznych lub kwartalnych informacji podsumowujących VAT-UE,</li>" +
          "<li>sporządzenie ewidencji wyposażenia oraz ewidencji środków trwałych i wartości niematerialnych i prawnych, ustalenie planu rocznej amortyzacji oraz rozliczanie miesięcznych odpisów amortyzacyjnych,</li>" +
          "<li>roczne rozliczenie podatku, sporządzenie rocznych deklaracji podatkowych.</li>"
     document.getElementById("collapseCard").innerHTML = document.getElementById('podatkowaKsiega').innerHTML;
     location.href = "#oferta";
...
function rejestracjaDzialalnosci() {
     document.getElementById("collapseMain").innerHTML = "<p>Oferujemy pełne wsparcie przy zakładaniu własnej działalności gospodarczej. Jeśli masz pomysł na biznes – pomożemy Ci zaoszczędzić czas i nerwy. Przeprowadzimy Cię przez proces wszystkich formalności związanych z założeniem firmy.</p>" +
     ...
     document.getElementById("collapseCard").innerHTML = document.getElementById('rejestracjaDzialalnosci').innerHTML;
     location.href = "#oferta";
...
function uslugiDodatkowe() {
     document.getElementById("collapseMain").innerHTML = "<li>organizacji systemu rachunkowości, w tym Polityki Rachunkowości,</li>" +
     ...
     document.getElementById("collapseCard").innerHTML = document.getElementById('uslugiDodatkowe').innerHTML;
     location.href = "#oferta";
